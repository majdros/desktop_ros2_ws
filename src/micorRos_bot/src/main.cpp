// source: https://github.com/micro-ROS/micro_ros_platformio/blob/main/examples/micro-ros_publisher/src/Main.cpp
// source: https://www.hackster.io/amal-shaji/differential-drive-robot-using-ros2-and-esp32-aae289
...
void setup() {
  ...
  RCCHECK(rclc_timer_init_default(&ControlTimer, &support, RCL_MS_TO_NS(samplingT), MotorControll_callback));
...
void subscription_callback(const void* msgin) {
  ...
  // Umwandeln der empfangenen Nachricht in das Twist-Nachrichtenformat
  const geometry_msgs__msg__Twist* msg = (const geometry_msgs__msg__Twist*)msgin;

  // Linear- und Winkelgeschwindigkeiten aus der Nachricht Twist
